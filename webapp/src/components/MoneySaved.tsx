...
export default function MoneySaved({ money }: MoneySavedProps) {
  ...
  return (
    <div className="w-full bg-bg-card rounded-xl px-4 py-3.5 shadow-card border border-white/[0.06] relative overflow-hidden flex items-center justify-between transition-transform duration-100 active:scale-[0.97]">
