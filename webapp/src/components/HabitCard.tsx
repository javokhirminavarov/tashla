...
export default function HabitCard({
  ...
  return (
    <button
      onClick={onSelect}
      className={`flex-1 min-w-[100px] bg-bg-surface rounded-xl p-3 flex flex-col items-center gap-1 border shadow-card transition-all active:scale-[0.97] transition-transform duration-100 ${
        selected
